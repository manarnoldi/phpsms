...
<table id="structure">
	<tr>
		...
		<td id="main_page">
			...
			<hr/>
			<form action="extracurriculum.php" method="POST">
				<h4>
				School Name:<br ><br >
				<input type="text" name="school_name" size="45" readonly style="background-color:#dddddd;" value="<?php echo $school_name; ?>" /><br ><br >
				Extra Curriculum Name:<br /><br />
				<input type="text" name="extra_curriculum" size="45" /><br ><br >
				Other Details:<br /><br />
				<textarea rows="5" cols="42" name="other_details"></textarea><br ><br >
				<input type="submit" name="submit" value="Register Extra Curriculum Activity" /><br ><br >
				<?php 
