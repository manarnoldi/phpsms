	...
	<table id="structure">
		<tr>
			...
			<td id="main_page">
				...
				<hr/>
				<form action="studentdiscipline.php" method="POST">
				<h4>
				School Name:<br ><br >
				...
				Discipline Record:<br /><br />
				<textarea rows="5" cols="42" name="discipline_record"></textarea><br ><br >
				Other Details:<br /><br />
				<textarea rows="5" cols="42" name="other_details"></textarea><br ><br >
				<input type="submit" name="submit" value="Register Discipline" /><br ><br >
				<?php 
